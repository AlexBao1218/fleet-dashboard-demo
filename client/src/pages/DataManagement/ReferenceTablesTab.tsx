...
import FuelProductMapDialog from '../FuelProductMap/FuelProductMapDialog';
import FuelProductMapTable from '../FuelProductMap/FuelProductMapTable';
...
const ReferenceTablesTab = () => {
  ...
  const handleExport = async (): Promise<void> => {
    setExporting(true);
    try {
      await exportApi.downloadTableCsv('fuel_product_map');
    } catch (error: unknown) {
      logger.error(`Failed to export fuel_product_map: ${JSON.stringify(error)}`);
...
export default ReferenceTablesTab;
